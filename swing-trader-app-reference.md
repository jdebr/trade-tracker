...
- **M19b.3 — Structured condition builder.** The `[variable][operator][value]` + AND/OR UI; becomes default with the JSON escape hatch (raw-JSON mode already built in M19b.2).
